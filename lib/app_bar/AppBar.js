...
var _reactTransformHmr2 = (0, _reactTransformHmr4.default)({
  filename: 'C:/src/thirdparty/react-toolbox/components/app_bar/AppBar.js',
  ...
  var AppBar = _wrapComponent('AppBar')((_temp2 = _class = function (_React$Component) {
    ...
    _createClass(AppBar, [{
      ...
      value: function render() {
        ...
        var renderedTitle = typeof title === 'string' ? _react3.default.createElement(
          'h1',
          { className: (0, _classnames2.default)(theme.title) },
          title
        ) : title;

        var renderedLeftIcon = leftIcon && _react3.default.createElement(IconButton, {
          inverse: true,
        ...
        var renderedRightIcon = rightIcon && _react3.default.createElement(IconButton, {
          inverse: true,
